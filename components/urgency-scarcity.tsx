          ...
          <CardContent className="p-3">
            <div className="flex items-center space-x-2">
              ...
              <div className="flex-1">
                <div className="font-semibold text-sm">{stockLeft <= 3 ? "Almost Sold Out!" : "Limited Stock"}</div>
                <div className="text-xs">Only {stockLeft} left in stock - order soon!</div>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-red-200 bg-gradient-to-r from-red-50 to-orange-50">
          <CardContent className="p-3">
            <div className="flex items-center space-x-2">
              ...
              <div className="flex-1">
                <div className="font-semibold text-sm text-red-700">Flash Deal Ends In:</div>
